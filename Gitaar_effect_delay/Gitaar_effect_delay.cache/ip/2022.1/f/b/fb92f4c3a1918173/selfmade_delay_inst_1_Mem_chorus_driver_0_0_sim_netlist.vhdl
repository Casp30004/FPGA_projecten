...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Mem_chorus_driver is
  ...
  signal adress_read : STD_LOGIC_VECTOR ( 15 downto 3 );
  ...
  signal \adress_read0__1_carry_i_4_n_0\ : STD_LOGIC;
  signal \adress_read0__1_carry_i_5_n_0\ : STD_LOGIC;
  ...
  signal adress_write : STD_LOGIC_VECTOR ( 15 downto 3 );
  ...
  signal \NLW_adress_read0__1_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_adress_read0__1_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  signal \NLW_adress_read2_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \adress_out[10]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \adress_out[11]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \adress_out[12]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \adress_out[13]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \adress_out[14]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \adress_out[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \adress_out[4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \adress_out[5]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \adress_out[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \adress_out[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \adress_out[8]_i_1\ : label is "soft_lutpair6";
...
\adress_read0__1_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \adress_read0__1_carry_i_1_n_0\,
      DI(2) => \adress_read0__1_carry_i_2_n_0\,
      DI(1) => adress_counter_reg(4),
      DI(0) => '0',
      O(3 downto 1) => adress_read(6 downto 4),
      O(0) => \NLW_adress_read0__1_carry_O_UNCONNECTED\(0),
      S(3) => \adress_read0__1_carry_i_3_n_0\,
      S(2) => \adress_read0__1_carry_i_4_n_0\,
      S(1) => \adress_read0__1_carry_i_5_n_0\,
      S(0) => adress_counter_reg(3)
    );
\adress_read0__1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => adress_counter_reg(9),
      DI(2) => \adress_read0__1_carry__0_i_1_n_0\,
      DI(1) => \adress_read0__1_carry__0_i_2_n_0\,
      DI(0) => '0',
      O(3 downto 0) => adress_read(10 downto 7),
      S(3) => \adress_read0__1_carry__0_i_3_n_0\,
      S(2) => \adress_read0__1_carry__0_i_4_n_0\,
      S(1) => \adress_read0__1_carry__0_i_5_n_0\,
      S(0) => \adress_read0__1_carry__0_i_6_n_0\
    );
...
\adress_read0__1_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"95"
    )
        port map (
...
\adress_read0__1_carry__0_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"69"
    )
        port map (
      I0 => \adress_read2_carry__2_n_1\,
      I1 => adress_counter_reg(10),
      I2 => adress_counter_reg(9),
      O => \adress_read0__1_carry__0_i_3_n_0\
    );
\adress_read0__1_carry__0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EA15"
    )
        port map (
...
\adress_read0__1_carry__0_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\adress_read0__1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => adress_counter_reg(14 downto 11),
      O(3 downto 0) => adress_read(14 downto 11),
...
\adress_read0__1_carry__1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
        ...
        port map (
      I0 => adress_counter_reg(14),
      I1 => \adress_read2_carry__2_n_1\,
      O => \adress_read0__1_carry__1_i_1_n_0\
    );
\adress_read0__1_carry__1_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\adress_read0__1_carry__1_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1E"
    )
        port map (
...
\adress_read0__1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_adress_read0__1_carry__2_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_adress_read0__1_carry__2_O_UNCONNECTED\(3 downto 1),
      O(0) => adress_read(15),
      S(3 downto 1) => B"000",
      S(0) => \adress_read0__1_carry__2_i_1_n_0\
    );
...
\adress_read0__1_carry_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\adress_read0__1_carry_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
      I0 => \adress_read2_carry__2_n_1\,
      I1 => adress_counter_reg(5),
      O => \adress_read0__1_carry_i_4_n_0\
    );
\adress_read0__1_carry_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => adress_counter_reg(4),
      O => \adress_read0__1_carry_i_5_n_0\
    );
adress_read2_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      O(0) => adress_read(3),
      S(3 downto 2) => adress_counter_reg(6 downto 5),
...
\adress_read2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => adress_counter_reg(10),
      DI(2 downto 1) => B"00",
      DI(0) => adress_counter_reg(7),
      O(3 downto 0) => \NLW_adress_read2_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \adress_read2_carry__0_i_1_n_0\,
      S(2 downto 1) => adress_counter_reg(9 downto 8),
      S(0) => \adress_read2_carry__0_i_2_n_0\
    );
...
\adress_read2_carry__1_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\adress_read2_carry__1_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\adress_read2_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_adress_read2_carry__2_CO_UNCONNECTED\(3),
      CO(2) => \adress_read2_carry__2_n_1\,
      CO(1) => \NLW_adress_read2_carry__2_CO_UNCONNECTED\(1),
      CO(0) => \adress_read2_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \adress_counter_reg__0\(16),
      DI(0) => adress_counter_reg(15),
      O(3 downto 2) => \NLW_adress_read2_carry__2_O_UNCONNECTED\(3 downto 2),
      O(1) => adress_read2(16),
      O(0) => \NLW_adress_read2_carry__2_O_UNCONNECTED\(0),
      S(3 downto 2) => B"01",
