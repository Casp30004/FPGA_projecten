...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_chorus_LFO is
  ...
  signal \sample_delay_buff[0]_i_17_n_0\ : STD_LOGIC;
  ...
  signal \sample_delay_buff_reg[0]_i_14_n_0\ : STD_LOGIC;
  signal \sample_delay_buff_reg[0]_i_14_n_1\ : STD_LOGIC;
  signal \sample_delay_buff_reg[0]_i_14_n_2\ : STD_LOGIC;
  signal \sample_delay_buff_reg[0]_i_14_n_3\ : STD_LOGIC;
  signal \sample_delay_buff_reg[0]_i_14_n_4\ : STD_LOGIC;
  signal \sample_delay_buff_reg[0]_i_14_n_5\ : STD_LOGIC;
  signal \sample_delay_buff_reg[0]_i_14_n_6\ : STD_LOGIC;
  signal \sample_delay_buff_reg[0]_i_14_n_7\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \counter[13]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter[13]_i_5\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \sample_delay_buff[0]_i_5\ : label is "soft_lutpair1";
  attribute ADDER_THRESHOLD of \sample_delay_buff_reg[0]_i_14\ : label is 35;
...
flag_i_1: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \sample_delay_buff[0]_i_3_n_0\,
      I3 => flag_reg_n_0,
      I4 => \sample_delay_buff[0]_i_5_n_0\,
      O => flag_i_1_n_0
    );
...
\sample_delay_buff[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0080008A"
    )
        port map (
      I0 => \sample_delay_buff[0]_i_3_n_0\,
      I1 => \sample_delay_buff[0]_i_4_n_0\,
      I2 => flag_reg_n_0,
      I3 => \sample_delay_buff[0]_i_5_n_0\,
      I4 => \flag0_carry__0_n_1\,
      O => \sample_delay_buff[0]_i_1_n_0\
    );
\sample_delay_buff[0]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\sample_delay_buff[0]_i_11\: unisim.vcomponents.LUT6
    generic map(
...
\sample_delay_buff[0]_i_13\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
      ...
      I2 => sample_delay_buff_reg(6),
      I3 => sample_delay_buff_reg(7),
      I4 => sample_delay_buff_reg(9),
      O => \sample_delay_buff[0]_i_13_n_0\
    );
\sample_delay_buff[0]_i_15\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00002000"
    )
        port map (
      I0 => \counter[13]_i_3_n_0\,
      I1 => \flag0_carry__0_n_1\,
      I2 => counter(3),
      I3 => counter(1),
      I4 => \counter[13]_i_4_n_0\,
      O => \sample_delay_buff[0]_i_15_n_0\
    );
\sample_delay_buff[0]_i_17\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => sample_delay_buff_reg(4),
      O => \sample_delay_buff[0]_i_17_n_0\
    );
\sample_delay_buff[0]_i_18\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\sample_delay_buff[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000100"
        ...
        port map (
      I0 => \sample_delay_buff[0]_i_10_n_0\,
      I1 => counter(8),
      I2 => counter(6),
      I3 => counter(1),
      I4 => counter(2),
      I5 => \sample_delay_buff[0]_i_11_n_0\,
      O => \sample_delay_buff[0]_i_3_n_0\
    );
\sample_delay_buff[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"000D"
    )
        port map (
      I0 => \sample_delay_buff[0]_i_12_n_0\,
      I1 => \sample_delay_buff[0]_i_13_n_0\,
      I2 => \sample_delay_buff_reg__0\(12),
      I3 => sample_delay_buff_reg(11),
      O => \sample_delay_buff[0]_i_4_n_0\
    );
\sample_delay_buff[0]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\sample_delay_buff[0]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      I0 => sample_delay_buff_reg(3),
      I1 => flag_reg_n_0,
      I2 => \sample_delay_buff_reg[0]_i_14_n_5\,
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(3),
      O => \sample_delay_buff[0]_i_6_n_0\
    );
\sample_delay_buff[0]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      I0 => sample_delay_buff_reg(2),
      I1 => flag_reg_n_0,
      I2 => \sample_delay_buff_reg[0]_i_14_n_6\,
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(2),
      O => \sample_delay_buff[0]_i_7_n_0\
    );
\sample_delay_buff[0]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      I0 => sample_delay_buff_reg(1),
      I1 => flag_reg_n_0,
      I2 => \sample_delay_buff_reg[0]_i_14_n_7\,
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(1),
...
\sample_delay_buff[12]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
...
\sample_delay_buff[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      ...
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(7),
      O => \sample_delay_buff[4]_i_2_n_0\
    );
\sample_delay_buff[4]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      ...
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(6),
      O => \sample_delay_buff[4]_i_3_n_0\
    );
\sample_delay_buff[4]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      ...
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(5),
      O => \sample_delay_buff[4]_i_4_n_0\
    );
\sample_delay_buff[4]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      I0 => sample_delay_buff_reg(4),
      I1 => flag_reg_n_0,
      I2 => \sample_delay_buff_reg[0]_i_14_n_4\,
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(4),
...
\sample_delay_buff[8]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      ...
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(11),
      O => \sample_delay_buff[8]_i_2_n_0\
    );
\sample_delay_buff[8]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      ...
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(10),
      O => \sample_delay_buff[8]_i_3_n_0\
    );
\sample_delay_buff[8]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      ...
      I3 => \sample_delay_buff[0]_i_15_n_0\,
      I4 => sample_delay_buff0(9),
      O => \sample_delay_buff[8]_i_4_n_0\
    );
\sample_delay_buff[8]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
...
\sample_delay_buff_reg[0]_i_14\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \sample_delay_buff_reg[0]_i_14_n_0\,
      CO(2) => \sample_delay_buff_reg[0]_i_14_n_1\,
      CO(1) => \sample_delay_buff_reg[0]_i_14_n_2\,
      CO(0) => \sample_delay_buff_reg[0]_i_14_n_3\,
      CYINIT => sample_delay_buff_reg(0),
      DI(3 downto 0) => sample_delay_buff_reg(4 downto 1),
      O(3) => \sample_delay_buff_reg[0]_i_14_n_4\,
      O(2) => \sample_delay_buff_reg[0]_i_14_n_5\,
      O(1) => \sample_delay_buff_reg[0]_i_14_n_6\,
      O(0) => \sample_delay_buff_reg[0]_i_14_n_7\,
      S(3) => \sample_delay_buff[0]_i_17_n_0\,
      S(2) => \sample_delay_buff[0]_i_18_n_0\,
      S(1) => \sample_delay_buff[0]_i_19_n_0\,
      S(0) => \sample_delay_buff[0]_i_20_n_0\
    );
...
\sample_delay_buff_reg[0]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \sample_delay_buff[0]_i_6_n_0\,
      S(2) => \sample_delay_buff[0]_i_7_n_0\,
      S(1) => \sample_delay_buff[0]_i_8_n_0\,
      S(0) => \sample_delay_buff[0]_i_9_n_0\
    );
...
\sample_delay_buff_reg[4]_i_6\: unisim.vcomponents.CARRY4
     port map (
      CI => \sample_delay_buff_reg[0]_i_14_n_0\,
