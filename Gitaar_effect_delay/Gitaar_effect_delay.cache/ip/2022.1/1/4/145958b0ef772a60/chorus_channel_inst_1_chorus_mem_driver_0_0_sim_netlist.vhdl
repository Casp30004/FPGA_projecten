...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_chorus_mem_driver is
  ...
  signal adress_read2 : STD_LOGIC_VECTOR ( 12 to 12 );
  ...
  signal \NLW_adress_counter_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_adress_counter_reg[12]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  signal \NLW_adress_read2_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_adress_read2_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \adress_read[10]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \adress_read[11]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \adress_read[12]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \adress_read[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \adress_read[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \adress_read[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \adress_read[4]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \adress_read[5]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \adress_read[6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \adress_read[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \adress_read[8]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \adress_read[9]_i_1\ : label is "soft_lutpair11";
...
\adress_counter0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => adress_counter_reg(12),
      S(1) => \adress_counter0_carry__0_i_1_n_0\,
      S(0) => \adress_counter0_carry__0_i_2_n_0\
    );
...
\adress_counter_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_adress_counter_reg[12]_i_1_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_adress_counter_reg[12]_i_1_O_UNCONNECTED\(3 downto 1),
...
\adress_read0_carry__0_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\adress_read2_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(0) => \NLW_adress_read2_carry__2_CO_UNCONNECTED\(0),
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => adress_counter_reg(12),
      O(3 downto 1) => \NLW_adress_read2_carry__2_O_UNCONNECTED\(3 downto 1),
      O(0) => adress_read2(12),
      S(3 downto 1) => B"001",
      S(0) => \adress_read2_carry__2_i_1_n_0\
    );
