...
-- Command     : write_vhdl -force -mode funcsim -rename_top delay_channel_1_inst_2_Audio_to_axis_0_0 -prefix
--               delay_channel_1_inst_2_Audio_to_axis_0_0_ delay_channel_1_inst_1_Audio_to_axis_0_0_sim_netlist.vhdl
...
entity delay_channel_1_inst_2_Audio_to_axis_0_0_Audio_to_axis is
  port (
...
end delay_channel_1_inst_2_Audio_to_axis_0_0_Audio_to_axis;

architecture STRUCTURE of delay_channel_1_inst_2_Audio_to_axis_0_0_Audio_to_axis is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity delay_channel_1_inst_2_Audio_to_axis_0_0 is
  port (
    audio_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
    m_axis_data_tdata : out STD_LOGIC_VECTOR ( 23 downto 0 );
    m_axis_data_tready : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of delay_channel_1_inst_2_Audio_to_axis_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of delay_channel_1_inst_2_Audio_to_axis_0_0 : entity is "delay_channel_1_inst_1_Audio_to_axis_0_0,Audio_to_axis,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of delay_channel_1_inst_2_Audio_to_axis_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of delay_channel_1_inst_2_Audio_to_axis_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of delay_channel_1_inst_2_Audio_to_axis_0_0 : entity is "Audio_to_axis,Vivado 2022.1";
end delay_channel_1_inst_2_Audio_to_axis_0_0;

architecture STRUCTURE of delay_channel_1_inst_2_Audio_to_axis_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of aclk : signal is "xilinx.com:signal:clock:1.0 aclk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of aclk : signal is "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF m_axis_data, FREQ_HZ 11289000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Delay_pedal_mclk_in, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of m_axis_data_tdata : signal is "XIL_INTERFACENAME m_axis_data, TDATA_NUM_BYTES 3, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 11289000, PHASE 0.0, CLK_DOMAIN Delay_pedal_mclk_in, LAYERED_METADATA undef, INSERT_VIP 0";
begin
U0: entity work.delay_channel_1_inst_2_Audio_to_axis_0_0_Audio_to_axis
     port map (
      aclk => aclk,
