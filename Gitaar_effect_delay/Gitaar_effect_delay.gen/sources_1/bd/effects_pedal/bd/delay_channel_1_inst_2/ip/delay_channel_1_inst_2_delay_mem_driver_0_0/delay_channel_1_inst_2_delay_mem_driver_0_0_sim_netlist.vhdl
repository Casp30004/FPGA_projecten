...
--               c:/gitaar_effect/Gitaar_effect_delay/Gitaar_effect_delay.gen/sources_1/bd/effects_pedal/bd/delay_channel_1_inst_2/ip/delay_channel_1_inst_2_delay_mem_driver_0_0/delay_channel_1_inst_2_delay_mem_driver_0_0_sim_netlist.vhdl
...
entity delay_channel_1_inst_2_delay_mem_driver_0_0_delay_mem_driver is
  port (
  ...
  attribute ORIG_REF_NAME of delay_channel_1_inst_2_delay_mem_driver_0_0_delay_mem_driver : entity is "delay_mem_driver";
end delay_channel_1_inst_2_delay_mem_driver_0_0_delay_mem_driver;

architecture STRUCTURE of delay_channel_1_inst_2_delay_mem_driver_0_0_delay_mem_driver is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity delay_channel_1_inst_2_delay_mem_driver_0_0 is
  port (
    ws_in : in STD_LOGIC;
    aclk : in STD_LOGIC;
    write_enable : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of delay_channel_1_inst_2_delay_mem_driver_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of delay_channel_1_inst_2_delay_mem_driver_0_0 : entity is "delay_channel_1_inst_2_delay_mem_driver_0_0,delay_mem_driver,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of delay_channel_1_inst_2_delay_mem_driver_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of delay_channel_1_inst_2_delay_mem_driver_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of delay_channel_1_inst_2_delay_mem_driver_0_0 : entity is "delay_mem_driver,Vivado 2022.1";
end delay_channel_1_inst_2_delay_mem_driver_0_0;

architecture STRUCTURE of delay_channel_1_inst_2_delay_mem_driver_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of aclk : signal is "xilinx.com:signal:clock:1.0 aclk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of aclk : signal is "XIL_INTERFACENAME aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 180, INSERT_VIP 0";
begin
U0: entity work.delay_channel_1_inst_2_delay_mem_driver_0_0_delay_mem_driver
     port map (
      aclk => aclk,
