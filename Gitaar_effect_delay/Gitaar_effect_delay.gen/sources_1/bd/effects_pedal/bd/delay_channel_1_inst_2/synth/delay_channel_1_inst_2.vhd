...
--Date        : Fri Feb  3 15:26:51 2023
--Host        : DESKTOP-6QOF9GB running 64-bit major release  (build 9200)
--Command     : generate_target delay_channel_1_inst_2.bd
--Design      : delay_channel_1_inst_2
...
end delay_imp_1S9JWPG;

architecture STRUCTURE of delay_imp_1S9JWPG is
  component delay_channel_1_inst_2_blk_mem_gen_0_0 is
  port (
    clka : in STD_LOGIC;
    ena : in STD_LOGIC;
  ...
  end component delay_channel_1_inst_2_blk_mem_gen_0_0;
  component delay_channel_1_inst_2_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component delay_channel_1_inst_2_xlconstant_0_0;
  component delay_channel_1_inst_2_feedback_0_0 is
  port (
    audio_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
    audio_out : out STD_LOGIC_VECTOR ( 23 downto 0 );
    mix : in STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component delay_channel_1_inst_2_feedback_0_0;
  component delay_channel_1_inst_2_c_addsub_0_0 is
  port (
    A : in STD_LOGIC_VECTOR ( 23 downto 0 );
    B : in STD_LOGIC_VECTOR ( 23 downto 0 );
    S : out STD_LOGIC_VECTOR ( 23 downto 0 )
  );
  end component delay_channel_1_inst_2_c_addsub_0_0;
  component delay_channel_1_inst_2_delay_mem_driver_0_0 is
  port (
    ws_in : in STD_LOGIC;
    aclk : in STD_LOGIC;
  ...
  end component delay_channel_1_inst_2_delay_mem_driver_0_0;
  ...
  signal delay_mem_driver_0_adress_out : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal delay_mem_driver_0_data_write : STD_LOGIC_VECTOR ( 23 downto 0 );
  signal delay_mem_driver_0_write_enable : STD_LOGIC;
...
begin
  ...
  ws_in_1 <= ws_in;
blk_mem_gen_0: component delay_channel_1_inst_2_blk_mem_gen_0_0
     port map (
      addra(15 downto 0) => delay_mem_driver_0_adress_out(15 downto 0),
      clka => Net,
      dina(23 downto 0) => delay_mem_driver_0_data_write(23 downto 0),
      douta(23 downto 0) => blk_mem_gen_0_douta(23 downto 0),
      ena => xlconstant_0_dout(0),
      wea(0) => delay_mem_driver_0_write_enable
    );
c_addsub_0: component delay_channel_1_inst_2_c_addsub_0_0
     port map (
      A(23 downto 0) => audio_in_1(23 downto 0),
      B(23 downto 0) => feedback_0_audio_out(23 downto 0),
      S(23 downto 0) => c_addsub_0_S(23 downto 0)
    );
delay_mem_driver_0: component delay_channel_1_inst_2_delay_mem_driver_0_0
     port map (
      aclk => Net,
      adress_out(15 downto 0) => delay_mem_driver_0_adress_out(15 downto 0),
      audio_in(23 downto 0) => c_addsub_0_S(23 downto 0),
      data_read(23 downto 0) => blk_mem_gen_0_douta(23 downto 0),
      data_write(23 downto 0) => delay_mem_driver_0_data_write(23 downto 0),
      delay(23 downto 0) => Mem_chorus_driver_0_delay(23 downto 0),
      delay_sample(15 downto 0) => delay_sample_1(15 downto 0),
      write_enable => delay_mem_driver_0_write_enable,
      ws_in => ws_in_1
    );
feedback_0: component delay_channel_1_inst_2_feedback_0_0
     port map (
...
xlconstant_0: component delay_channel_1_inst_2_xlconstant_0_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity filter_stage_imp_L1RWVP is
  port (
    aclk : in STD_LOGIC;
    audio_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
...
end filter_stage_imp_L1RWVP;

architecture STRUCTURE of filter_stage_imp_L1RWVP is
  component delay_channel_1_inst_2_Audio_to_axis_0_0 is
  port (
    audio_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  end component delay_channel_1_inst_2_Audio_to_axis_0_0;
  component delay_channel_1_inst_2_fir_compiler_0_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component delay_channel_1_inst_2_fir_compiler_0_0;
  component delay_channel_1_inst_2_fir_resizer_0_0 is
  port (
    input_audio : in STD_LOGIC_VECTOR ( 25 downto 0 );
    output_audio : out STD_LOGIC_VECTOR ( 23 downto 0 )
  );
  end component delay_channel_1_inst_2_fir_resizer_0_0;
  component delay_channel_1_inst_2_fir_compiler_1_0 is
  port (
    aclk : in STD_LOGIC;
    s_axis_data_tvalid : in STD_LOGIC;
    s_axis_data_tready : out STD_LOGIC;
  ...
  end component delay_channel_1_inst_2_fir_compiler_1_0;
  component delay_channel_1_inst_2_fir_resizer_1_0 is
  port (
    input_audio : in STD_LOGIC_VECTOR ( 25 downto 0 );
    output_audio : out STD_LOGIC_VECTOR ( 23 downto 0 )
  );
  end component delay_channel_1_inst_2_fir_resizer_1_0;
...
begin
  ...
  ws_in_1 <= ws_in;
Audio_to_axis_0: component delay_channel_1_inst_2_Audio_to_axis_0_0
     port map (
      aclk => aclk_1,
...
fir_compiler_0: component delay_channel_1_inst_2_fir_compiler_0_0
     port map (
      aclk => aclk_1,
...
fir_compiler_1: component delay_channel_1_inst_2_fir_compiler_1_0
     port map (
      aclk => aclk_1,
...
fir_resizer_0: component delay_channel_1_inst_2_fir_resizer_0_0
     port map (
...
fir_resizer_1: component delay_channel_1_inst_2_fir_resizer_1_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity delay_channel_1_inst_2 is
  port (
    aclk_0 : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of delay_channel_1_inst_2 : entity is "delay_channel_1_inst_2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=delay_channel_1_inst_2,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=12,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=C_/gitaar_effect/Gitaar_effect_delay/Gitaar_effect_delay.gen/sources_1/bd/Delay_pedal/bd/delay_channel_1_inst_0/delay_channel_1_inst_0.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of delay_channel_1_inst_2 : entity is "delay_channel_1_inst_2.hwdef";
end delay_channel_1_inst_2;

architecture STRUCTURE of delay_channel_1_inst_2 is
...
begin
  ...
  ws_in_0_1 <= ws_in_0;
delay: entity work.delay_imp_1S9JWPG
     port map (
      aclk => aclk_0_1,
...
filter_stage: entity work.filter_stage_imp_L1RWVP
     port map (
      aclk => aclk_0_1,
