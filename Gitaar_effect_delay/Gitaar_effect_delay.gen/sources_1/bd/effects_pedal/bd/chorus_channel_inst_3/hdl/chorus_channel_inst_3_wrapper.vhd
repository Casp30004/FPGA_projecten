...
--Command     : generate_target chorus_channel_inst_3_wrapper.bd
--Design      : chorus_channel_inst_3_wrapper
...
entity chorus_channel_inst_3_wrapper is
  port (
    aclk : in STD_LOGIC;
...
end chorus_channel_inst_3_wrapper;

architecture STRUCTURE of chorus_channel_inst_3_wrapper is
  component chorus_channel_inst_3 is
  port (
    audio_in_0 : in STD_LOGIC_VECTOR ( 23 downto 0 );
    ws_in_0 : in STD_LOGIC;
    aclk : in STD_LOGIC;
  ...
  end component chorus_channel_inst_3;
begin
chorus_channel_inst_3_i: component chorus_channel_inst_3
     port map (
      aclk => aclk,
