...
--Date        : Fri Feb  3 15:26:53 2023
--Host        : DESKTOP-6QOF9GB running 64-bit major release  (build 9200)
--Command     : generate_target chorus_channel_inst_3.bd
--Design      : chorus_channel_inst_3
...
end delay_imp_1W90JU6;

architecture STRUCTURE of delay_imp_1W90JU6 is
  component chorus_channel_inst_3_feedback_0_0 is
  port (
    audio_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
    audio_out : out STD_LOGIC_VECTOR ( 23 downto 0 );
    mix : in STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component chorus_channel_inst_3_feedback_0_0;
  component chorus_channel_inst_3_blk_mem_gen_0_0 is
  port (
    clka : in STD_LOGIC;
  ...
  end component chorus_channel_inst_3_blk_mem_gen_0_0;
  component chorus_channel_inst_3_c_addsub_0_0 is
  port (
    A : in STD_LOGIC_VECTOR ( 23 downto 0 );
    B : in STD_LOGIC_VECTOR ( 23 downto 0 );
    S : out STD_LOGIC_VECTOR ( 23 downto 0 )
  );
  end component chorus_channel_inst_3_c_addsub_0_0;
  component chorus_channel_inst_3_chorus_mem_driver_0_0 is
  port (
    ws_in : in STD_LOGIC;
    aclk : in STD_LOGIC;
  ...
  end component chorus_channel_inst_3_chorus_mem_driver_0_0;
...
begin
  ...
  ws_in_1_1 <= ws_in_1;
blk_mem_gen_0: component chorus_channel_inst_3_blk_mem_gen_0_0
     port map (
...
c_addsub_0: component chorus_channel_inst_3_c_addsub_0_0
     port map (
...
chorus_mem_driver_0: component chorus_channel_inst_3_chorus_mem_driver_0_0
     port map (
      aclk => Net,
...
feedback_0: component chorus_channel_inst_3_feedback_0_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity chorus_channel_inst_3 is
  port (
    aclk : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of chorus_channel_inst_3 : entity is "chorus_channel_inst_3,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=chorus_channel_inst_3,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=6,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=c_/gitaar_effect/Gitaar_effect_delay/Gitaar_effect_delay.gen/sources_1/bd/Chorus_effect/bd/chorus_channel_inst_0/chorus_channel_inst_0.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of chorus_channel_inst_3 : entity is "chorus_channel_inst_3.hwdef";
end chorus_channel_inst_3;

architecture STRUCTURE of chorus_channel_inst_3 is
  component chorus_channel_inst_3_chorus_LFO_0_0 is
  port (
  ...
  end component chorus_channel_inst_3_chorus_LFO_0_0;
...
begin
  ...
  mix_0_1(7 downto 0) <= mix_0(7 downto 0);
  ws_in_0_1 <= ws_in_0;
chorus_LFO_0: component chorus_channel_inst_3_chorus_LFO_0_0
     port map (
...
delay: entity work.delay_imp_1W90JU6
     port map (
      aclk => aclk_1,
