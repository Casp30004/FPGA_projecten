...
architecture STRUCTURE of Chorus is
  ...
  signal chorus_mem_driver_ip_0_bram_addr_a : STD_LOGIC_VECTOR ( 11 downto 0 );
  signal chorus_mem_driver_ip_0_bram_en_a : STD_LOGIC;
  ...
  signal NLW_chorus_mem_driver_ip_0_bram_wrdata_a_UNCONNECTED : STD_LOGIC_VECTOR ( 23 downto 0 );
...
blk_mem_gen_0: component Chorus_blk_mem_gen_0_0
     port map (
      addra(11 downto 0) => chorus_mem_driver_ip_0_bram_addr_a(11 downto 0),
      clka => '0',
      dina(23) => chorus_mem_driver_ip_0_bram_en_a,
      dina(22) => chorus_mem_driver_ip_0_bram_en_a,
      dina(21) => chorus_mem_driver_ip_0_bram_en_a,
      dina(20) => chorus_mem_driver_ip_0_bram_en_a,
      dina(19) => chorus_mem_driver_ip_0_bram_en_a,
      dina(18) => chorus_mem_driver_ip_0_bram_en_a,
      dina(17) => chorus_mem_driver_ip_0_bram_en_a,
      dina(16) => chorus_mem_driver_ip_0_bram_en_a,
      dina(15) => chorus_mem_driver_ip_0_bram_en_a,
      dina(14) => chorus_mem_driver_ip_0_bram_en_a,
      dina(13) => chorus_mem_driver_ip_0_bram_en_a,
      dina(12) => chorus_mem_driver_ip_0_bram_en_a,
      dina(11) => chorus_mem_driver_ip_0_bram_en_a,
      dina(10) => chorus_mem_driver_ip_0_bram_en_a,
      dina(9) => chorus_mem_driver_ip_0_bram_en_a,
      dina(8) => chorus_mem_driver_ip_0_bram_en_a,
      dina(7) => chorus_mem_driver_ip_0_bram_en_a,
      dina(6) => chorus_mem_driver_ip_0_bram_en_a,
      dina(5) => chorus_mem_driver_ip_0_bram_en_a,
      dina(4) => chorus_mem_driver_ip_0_bram_en_a,
      dina(3) => chorus_mem_driver_ip_0_bram_en_a,
      dina(2) => chorus_mem_driver_ip_0_bram_en_a,
      dina(1) => chorus_mem_driver_ip_0_bram_en_a,
      dina(0) => chorus_mem_driver_ip_0_bram_en_a,
      douta(23 downto 0) => blk_mem_gen_0_douta(23 downto 0),
      wea(0) => chorus_mem_driver_ip_0_bram_en_a
    );
...
chorus_mem_driver_ip_0: component Chorus_chorus_mem_driver_ip_0_0
     port map (
      ACLK => ACLK_1,
      bram_addr_a(11 downto 0) => chorus_mem_driver_ip_0_bram_addr_a(11 downto 0),
      bram_en_a => chorus_mem_driver_ip_0_bram_en_a,
      bram_rddata_a(23 downto 0) => blk_mem_gen_0_douta(23 downto 0),
      bram_wrdata_a(23 downto 0) => NLW_chorus_mem_driver_ip_0_bram_wrdata_a_UNCONNECTED(23 downto 0),
