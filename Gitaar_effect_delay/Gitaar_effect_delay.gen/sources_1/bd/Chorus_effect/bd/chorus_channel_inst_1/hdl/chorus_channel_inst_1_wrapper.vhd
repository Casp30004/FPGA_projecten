...
--Command     : generate_target chorus_channel_inst_1_wrapper.bd
--Design      : chorus_channel_inst_1_wrapper
...
entity chorus_channel_inst_1_wrapper is
  port (
    aclk : in STD_LOGIC;
...
end chorus_channel_inst_1_wrapper;

architecture STRUCTURE of chorus_channel_inst_1_wrapper is
...
begin
chorus_channel_inst_1_i: component chorus_channel_inst_1
     port map (
      aclk => aclk,
