...
--Command     : generate_target delay_channel_1_inst_1.bd
--Design      : delay_channel_1_inst_1
...
end delay_imp_Z4DGJ2;

architecture STRUCTURE of delay_imp_Z4DGJ2 is
  component delay_channel_1_inst_1_Mem_chorus_driver_0_0 is
  port (
    ws_in : in STD_LOGIC;
    aclk : in STD_LOGIC;
  ...
  end component delay_channel_1_inst_1_Mem_chorus_driver_0_0;
  component delay_channel_1_inst_1_blk_mem_gen_0_0 is
  port (
    clka : in STD_LOGIC;
    ena : in STD_LOGIC;
  ...
  end component delay_channel_1_inst_1_blk_mem_gen_0_0;
  component delay_channel_1_inst_1_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component delay_channel_1_inst_1_xlconstant_0_0;
  component delay_channel_1_inst_1_feedback_0_0 is
  port (
    audio_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
    audio_out : out STD_LOGIC_VECTOR ( 23 downto 0 );
    mix : in STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component delay_channel_1_inst_1_feedback_0_0;
  component delay_channel_1_inst_1_c_addsub_0_0 is
  port (
    A : in STD_LOGIC_VECTOR ( 23 downto 0 );
    B : in STD_LOGIC_VECTOR ( 23 downto 0 );
    S : out STD_LOGIC_VECTOR ( 23 downto 0 )
  );
  end component delay_channel_1_inst_1_c_addsub_0_0;
...
begin
  ...
  ws_in_1 <= ws_in;
Mem_chorus_driver_0: component delay_channel_1_inst_1_Mem_chorus_driver_0_0
     port map (
      aclk => Net,
...
blk_mem_gen_0: component delay_channel_1_inst_1_blk_mem_gen_0_0
     port map (
...
xlconstant_0: component delay_channel_1_inst_1_xlconstant_0_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity filter_stage_imp_1MHYU1B is
  port (
    aclk : in STD_LOGIC;
    audio_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
...
end filter_stage_imp_1MHYU1B;

architecture STRUCTURE of filter_stage_imp_1MHYU1B is
  component delay_channel_1_inst_1_Audio_to_axis_0_0 is
  port (
    audio_in : in STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  end component delay_channel_1_inst_1_Audio_to_axis_0_0;
  component delay_channel_1_inst_1_fir_compiler_0_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component delay_channel_1_inst_1_fir_compiler_0_0;
  component delay_channel_1_inst_1_fir_resizer_0_0 is
  port (
    input_audio : in STD_LOGIC_VECTOR ( 25 downto 0 );
    output_audio : out STD_LOGIC_VECTOR ( 23 downto 0 )
  );
  end component delay_channel_1_inst_1_fir_resizer_0_0;
  component delay_channel_1_inst_1_fir_compiler_1_0 is
  port (
    aclk : in STD_LOGIC;
    s_axis_data_tvalid : in STD_LOGIC;
    s_axis_data_tready : out STD_LOGIC;
  ...
  end component delay_channel_1_inst_1_fir_compiler_1_0;
  component delay_channel_1_inst_1_fir_resizer_1_0 is
  port (
    input_audio : in STD_LOGIC_VECTOR ( 25 downto 0 );
    output_audio : out STD_LOGIC_VECTOR ( 23 downto 0 )
  );
  end component delay_channel_1_inst_1_fir_resizer_1_0;
...
begin
  ...
  ws_in_1 <= ws_in;
Audio_to_axis_0: component delay_channel_1_inst_1_Audio_to_axis_0_0
     port map (
      aclk => aclk_1,
...
fir_compiler_0: component delay_channel_1_inst_1_fir_compiler_0_0
     port map (
      aclk => aclk_1,
...
fir_compiler_1: component delay_channel_1_inst_1_fir_compiler_1_0
     port map (
      aclk => aclk_1,
...
fir_resizer_0: component delay_channel_1_inst_1_fir_resizer_0_0
     port map (
...
fir_resizer_1: component delay_channel_1_inst_1_fir_resizer_1_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity delay_channel_1_inst_1 is
  port (
    aclk_0 : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of delay_channel_1_inst_1 : entity is "delay_channel_1_inst_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=delay_channel_1_inst_1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=12,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=C_/gitaar_effect/Gitaar_effect_delay/Gitaar_effect_delay.srcs/sources_1/bd/delay_channel_1/delay_channel_1.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of delay_channel_1_inst_1 : entity is "delay_channel_1_inst_1.hwdef";
end delay_channel_1_inst_1;

architecture STRUCTURE of delay_channel_1_inst_1 is
...
begin
  ...
  ws_in_0_1 <= ws_in_0;
delay: entity work.delay_imp_Z4DGJ2
     port map (
      aclk => aclk_0_1,
...
filter_stage: entity work.filter_stage_imp_1MHYU1B
     port map (
      aclk => aclk_0_1,
